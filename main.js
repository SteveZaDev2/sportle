    ...
    { 
      ...
      items: [],
    },
        {
          ...
          parent: "HallsOfFame",
          numOfItems: 0,
          items: ["BABE RUTH", "TY COBB", "WALTER JOHNSON", "CHRISTY MATHEWSON", "HONUS WAGNER", "NAP LAJOIE", "CONNIE MACK", "JOHN MCGRAW", "TRIS SPEAKER", "CY YOUNG", "GROVER CLEVELAND ALEXANDER", "CAP ANSON, EDDIE COLLINS", "BUCK EWING", "LOU GEHRIG", "WILLIE KEELER", "GEORGE SISLER", "ROGERS HORNSBY", "ROGER BRESNAHAN", "FRED CLARKE", "JIMMY COLLINS", "ED DELAHANTY", "HUGH DUFFY", "HUGH JENNINGS", "KING KELLY", "JIM OROURK", "JESSE BURKETT", "FRANK CHANCE", "JACK CHESBRO", "JOHNNY EVERS", "TOMMY MCCARTHY", "JOE MCGINNITY", "EDDIE PLANK", "JOE TINKER", "RUBE WADDELL", "ED WALSH", "MICKEY COCHRANE", "FRANKIE FRISCH", "LEFTY GROVE", "CARL HUBBELL", "HERB PENNOCK", "PIE TRAYNOR", "MORDECAI BROWN", "CHARLIE GEHRINGER", "KID NICHOLS", "JIMMY FOXX", "MEL OTT", "HARRY HEILMANN", "PAUL WANER", "CHIEF BENDER", "DIZZY DEAN", "AL SIMMONS", "BOBBY WALLACE", "BILL DICKEY", "RABBIT MARANVILLE", "BILL TERRY", "FRANK BAKER", "JOE DIMAGGIO", "GABBY HARTNETT", "TED LYONS", "RAY SCHALK", "DAZZY VANCE", "JOE CRONIN", "HANK GREENBERG", "SAM CRAWFORD", "JOE MCCARTHY", "ZACK WHEAT", "MAX CAREY", "BILLY HAMILTON", "BOB FELLER", "JACKIE ROBINSON", "EDD ROUSCH", "JOHN CLARKSON", "ELMER FLICK", "SAM RICE", "EPPA RIXEY", "LUKE APPLING", "RED FABER", "BURLEIGH GRIMES", "MILLER HUGGINS", "TIM KEEFE", "HEINIE MANUSH", "JOHN MONTGOMERY WARD", "PUD GALVIN", "CASE STENGEL", "TED WILLIAMS", "RED RUFFING", "LLOYD WANER", "KIKI CUYLER", "GOOSE GOSLIN", "JOE MEDWICK", "ROY CAMPANELLA", "STAN COVELESKI", "WAITE HOYT", "STAN MUSIAL", "LOU BOUDREAU", "EARLE COMBS", "JESSE HAINES", "DAVE BANCROFT", "JAKE BECKLEY", "CHICK HAFEY", "HARRY HOOPER", "JOE KELLEY", "RUBE MARQUARD", "SATCHEL PAIGE", "YOGI BERRA", "JOSH GIBSON", "LEFTY GOMEZ", "SANDY KOUFAX", "BUCK LEONARD", "EARLY WYNN", "ROSS YOUNGS", "ROBERTO CLEMENTE", "MONTE IRVIN", "GEORGE KELLY", "WARREN SPAHN", "MICKEY WELCH", "COOL PAPA BELL", "JIM BOTTOMLEY", "WHITEY FORD", "MICKEY MANTLE", "SAM THOMPSON", "EARL AVERILL", "BILLY HERMAN", "JUDY JOHNSON", "RALPH KINER", "OSCAR CHARLESTON", "ROGER CONNOR", "BOB LEMON", "FREDDIE LINDSTROM", "ROBIN ROBERTS", "ERNIE BANKS", "POP LLOYD", "AL LOPEZ", "JOE SEWELL", "EDDIE MATHEWS", "WILLY MAYS", "HACK WILSON", "AL KALINE", "CHUCK KLEIN", "DUKE SNIDER", "BOB GIBSON", "JOHNNY MIZE", "HANK AARON", "FRANK ROBINSON", "GEORGE KELL", "JUAN MARICHAL", "BROOKS ROBINSON", "LUIS APARICIO", "DON DRYSDALE", "RICK FERRELL", "HARMON KILLEBREW", "PEE WEE REESE", "LOU BROCK", "ENOS SLAUGHTER", "ARKY VAUGHAN", "HOYT WILHELM", "BOBBY DOERR", "ERNIE LOMBARDI", "WILLIE MCCOVERY", "CATFISH HUNTER", "BILLY WILLIAMS", "WILLIE STARGELL", "JOHNNY BENCH", "RED SCHOENDIENST", "CARL YASTRZEMSKI", "JOE MORGAN", "JIM PALMER", "ROD CAREW", "FERGUSON JENKINS", "TONY LAZZERI", "GAYLORD PERRY", "ROLLIE FINGERS", "HAL NEWHOUSER", "TOM SEAVER", "REGGIE JACKSON", "STEVE CARLTON", "LEO DUROCHER", "PHIL RIZZUTO", "RICHIE ASHBURN", "MIKE SCHMIDT", "VIC WILLIS", "JIM BUNNING", "EARL WEAVER", "NELLIE FOX", "TOMMY LASORDA", "PHIL NIEKRO", "LARRY DOBY", "DON SUTTON", "GEORGE BRETT", "ORLANDO CEPEDA", "NOLAN RYAN", "NESTOR CHYLAK", "ROBIN YOUNT", "SPARKY ANDERSON", "CARLTON FISK", "TONY PEREZ", "BILL MAZEROSKI", "KIRBY PUCKETT", "DAVE WINFIELD", "OZZIE SMITH", "GARY CARTER", "EDDIE MURRAY", "DENNIS ECKERSLEY", "PAUL MOLITOR", "WADE BOGGS", "RYNE SANDBERG", "BRUCE SUTTER", "TONY GWYNN", "CAL RIPKEN JR", "RICH GOSSAGE", "JOE GORDON", "RICKEY HENDERSON", "JIM RICE", "ANDRE DAWSON", "ROBERTO ALOMAR", "BERT BLYLEVEN", "BARRY LARKIN", "RON SANTO", "TOM GLAVINE", "GREG MADDUX", "FRANK THOMAS", "JOE TORRE", "CRAIG BIGGIO", "RANDY JOHNSON", "PEDRO MARTINEZ", "JOHN SMOLTZ", "KEN GRIFFEY JR", "MIKE PIAZZA", "JEFF BAGWELL", "TIM RAINES", "IVAN RODRIGUEZ", "VLADIMIR GUERRERO", "TREVOR HOFFMAN", "CHIPPER JONES", "JIM THOME", "JACK MORRIS", "ALAN TRAMMELL", "MARIANO RIVERA", "ROY HALLADAY", "EDGAR MARTINEZ", "MIKE MUSSINA", "HAROLD BAINES", "LEE SMITH", "DEREK JETER", "LARRY WALKER", "TED SIMMONS", "DAVID ORTIZ", "GIL HODGES", "JIM KAAT", "MINNIE MINOSO", "TONY OLIVA", "SCOTT ROLEN", "FRED MCGRIFF"]
          },
        {
          cat: "Football",
          sel: false,
          parent: "HallsOfFame",
          numOfItems: 0,
          items: ["ROGER STAUBACH", "HERB ADDERLY", "TROY AIKMAN", "LARRY ALLEN", "GEORGE ALLEN", "MARCUS ALLEN", "LANCE ALWORTH", "MORTEN ANDERSEN", "DOUG ATKINS", "STEVE ATWATER", "RONDE BARBER", "LEM BARNEY", "CLIFF BATTLES", "SAMMY BAUGH", "CHUCK BEDNARIK", "BOBBY BELL", "RAYMOND BERRY", "ELVIN BETHEA", "JEROME BETTIS", "FRED BILETNIKOFF", "GEORGE BLANDA", "MEL BLOUNT", "TONY BOSELLI", "TERRY BRADSHAW", "CLIFF BRANCH", "ROBERT BRAZILE", "DERRICK BROOKS", "BOB BROWN", "JIM BROWN", "ROSEY BROWN", "TIM BROWN", "WILLIE BROWN", "ISAAC BRUCE", "BUCK BUCHANAN", "NICK BUONICONTI", "DICK BUTKUS", "LEROY BUTLER", "EARL CAMPBELL", "HAROLD CARMICHAEL", "HARRY CARSON", "CRIS CARTER", "DAVE CASPER", "LARRY CSONKA", "CURLEY CULP", "TERREL DAVIS", "WILLIE DAVIS", "BRIAN DAWKINS", "LEN DAWSON", "FRED DEAN", "JOE DELAMIELLEURE", "RICHARD DENT", "DAN DIERDORF", "MIKE DITKA", "CHRIS DOLEMAN", "ART DONOVAN", "TONY DORSETT", "KENNY EASLEY", "CARL ELLER", "JOHN ELWAY", "MARSHALL FAULK", "BRETT FAVRE", "TOM FEARS", "DAN FOUTS", ""]
          },      
        {
          cat: "Basketball",
          sel: false,
  ...
  */
  ...
  function handleSubmitWord(){
   ...
   //     console.log("guess letter2 = " + guess.letter + "   wordle letter = " + wordle[index])
    ...
    let interval = 3500 / numofLetters;
